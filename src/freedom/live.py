...
DEFAULT_CLOCK_NY: dict[str, str] = {Timing.amc.value: "16:05", Timing.bmo.value: "07:00"}
...
def predict_event(settings: Settings, *, event_id: str, decision: str, model_name: str | None = None,
    ...
    row. Returns {row, features, contributions, schedule, model_meta, consensus}."""
...
def append_live_prediction(settings: Settings, row: dict) -> Path:
    ...
    for col in (D.as_of, "run_at", "t0_used", "expected_t0", "t0_live", "t0_actual", E.estimate_snapshot_time):
